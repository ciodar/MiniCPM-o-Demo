...
- [Video Full-Duplex Protocol](/en/realtime-api/video/) — full-duplex conversation with video frames.
- [Audio Full-Duplex Protocol](/en/realtime-api/audio/) — audio-only full-duplex conversation.
